...
class AppTranslations extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
      ...
      'no_contact_info': 'No contact information',
            // Added to match Thai-only keys
            'add_jobcard': 'Add Job Card',
            'additional_info': 'Additional Information',
      // Already existing keys reused above (coming_soon etc.) ensure not duplicated
            'chat_notification_toggle_success': 'Notifications toggled',
      ...
      // (removed duplicate 'from_job_card' key; using earlier key with colon)
            'history': 'History',
            'no_job_card_for_customer': 'No Job Card for this customer yet',
            'no_todos_for_customer': 'No to-dos for this customer yet',
    ...
    'th': {
      ...
      // Customer Detail Page (added 2025-09-24)
      // (Deprecated) customer_delete_* Thai keys superseded
      'customer_permission_denied_detail':
          'คุณไม่มีสิทธิ์ดูรายละเอียดลูกค้ารายนี้',
      'customer_permission_denied_jobcards':
          'คุณไม่มีสิทธิ์ดู Job Card ของลูกค้ารายนี้',
      'customer_permission_denied_todos':
          'คุณไม่มีสิทธิ์ดู To-Do ของลูกค้ารายนี้',
      'customer_no_jobcards': 'ยังไม่มี Job Card สำหรับลูกค้านี้',
      'customer_no_todos': 'ยังไม่มี To-Do สำหรับลูกค้านี้',
      'customer_section_history': 'ประวัติ',
      'customer_section_document_library': 'คลังเอกสาร',
      'customer_section_notes': 'โน๊ต',
      'customer_section_sales_documents': 'เอกสารการขาย',
      // Customer Detail additional sections & fields (TH)
      'customer_section_basic_info': 'ข้อมูลลูกค้า',
      'customer_section_contact_info': 'ข้อมูลติดต่อ',
      'customer_section_company_info': 'ข้อมูลบริษัท',
      'customer_section_address': 'ที่อยู่',
      'customer_section_additional_info': 'ข้อมูลเพิ่มเติม',
      'customer_section_system_info': 'ข้อมูลระบบ',
      'customer_field_customer_id': 'รหัสลูกค้า',
      'customer_field_name': 'ชื่อ',
      'customer_field_gender': 'เพศ',
      'customer_field_age': 'อายุ',
      'age_year_suffix': 'ปี',
      'customer_field_type': 'ประเภท',
      'customer_field_national_id': 'เลขประจำตัวประชาชน',
      'customer_field_source': 'แหล่งที่มา',
      'customer_field_created_at': 'สร้างเมื่อ',
      'customer_field_updated_at': 'อัปเดตล่าสุด',
      'from_job_card': 'จาก Job Card:',
      // Customer detail tab labels with counts
      'customer_tab_jobcards': 'Job Card ({count})',
      // Consolidated Customer Detail localized strings (th)
      'customer_detail_title': 'รายละเอียดลูกค้า',
      'confirm_delete_customer': 'ยืนยันการลบลูกค้า',
      'confirm_delete_customer_message':
          'คุณแน่ใจหรือไม่ว่าต้องการลบลูกค้า "{name}"?',
      'no_permission_view_jobcards_customer':
          'คุณไม่มีสิทธิ์ดู Job Card ของลูกค้ารายนี้',
      'no_jobcards_for_customer': 'ยังไม่มี Job Card สำหรับลูกค้านี้',
      'todo_due_date_with_value': 'กำหนดส่ง: {date}',
      'customer_tab_history_coming_soon': 'ประวัติ\n(Coming Soon)',
      'customer_tab_document_library_coming_soon': 'คลังเอกสาร\n(Coming Soon)',
      'customer_tab_notes_coming_soon': 'โน๊ต\n(Coming Soon)',
      'customer_tab_sales_documents_coming_soon': 'เอกสารการขาย\n(Coming Soon)',
      'customer_tab_todos': 'สิ่งที่ต้องทำ ({count})',
      'customer_tab_history': 'ประวัติ ({count})',
      'customer_tab_document_library': 'คลังเอกสาร ({count})',
      'customer_tab_notes': 'โน๊ต ({count})',
      'customer_tab_sales_documents': 'เอกสารการขาย ({count})',
      'coming_soon_multiline': 'Coming Soon',
      'repeat_purchase_count': 'จำนวนการซื้อซ้ำ',
      'total_payment_amount': 'ยอดชำระรวม',
      'customer_code_with_value': 'รหัสลูกค้า: {code}',
      'todo_completed': 'เสร็จแล้ว',
      'todo_not_completed': 'ยังไม่เสร็จ',
      'unspecified': 'ไม่ระบุ',
      ...
      'load_companies_failed_details':
          'ไม่สามารถโหลดรายชื่อบริษัทได้: {error}',
      ...
      'permission_denied_action':
          'คุณไม่มีสิทธิ์ดำเนินการ: {action}',
      ...
      'no_contact_info': 'ไม่มีข้อมูลติดต่อ',
            // Added to match English-only keys
            '+14_days': '+14 วัน',
            '+1_day': '+1 วัน',
            '+30_days': '+30 วัน',
            '+3_days': '+3 วัน',
            ...
            'bot_disabled': 'ปิดการตอบกลับอัตโนมัติ',
            'bot_enabled': 'เปิดการตอบกลับอัตโนมัติ',
            'bot_update_failed': 'อัปเดตบอทไม่สำเร็จ',
            'chat_bot_disable': 'ปิดบอท',
            'chat_bot_enable': 'เปิดบอท',
            'chat_default_name': 'แชท',
            'chat_details': 'รายละเอียดแชท',
            'chat_hashtag_update_failed': 'อัปเดตแฮชแท็กไม่สำเร็จ',
            'chat_hashtag_updated': 'อัปเดตแฮชแท็กแล้ว',
            'chat_pin_success': 'ปักหมุดสำเร็จ',
            'chat_pinned': 'ปักหมุดแล้ว',
            'chat_rename': 'เปลี่ยนชื่อแชท',
            'chat_rename_failed': 'เปลี่ยนชื่อแชทไม่สำเร็จ',
            'chat_rename_success': 'เปลี่ยนชื่อแชทสำเร็จ',
            'chat_sent_image': 'ส่งรูปภาพแล้ว',
            'chat_status': 'สถานะแชท',
            'chat_status_done': 'เสร็จสิ้น',
            'chat_status_in_progress': 'กำลังดำเนินการ',
            'chat_unpin_success': 'ยกเลิกปักหมุดสำเร็จ',
            'chat_unpinned': 'ยกเลิกปักหมุดแล้ว',
            'clear_filter': 'ล้างตัวกรอง',
            'comment': 'ความคิดเห็น',
            'company': 'บริษัท',
            'confirm_action': 'ยืนยันการทำรายการ',
            'confirm_action_message': 'คุณต้องการ {action} หรือไม่?',
            'confirm_remove_assignee': 'ยืนยันการลบผู้รับผิดชอบ',
            'confirm_remove_assignee_message': 'คุณแน่ใจหรือไม่ว่าต้องการลบ {name} ออกจากผู้รับผิดชอบ?',
            'create_invoice_from_quotation': 'สร้างใบแจ้งหนี้จากใบเสนอราคา',
            'create_receipt_from_invoice': 'สร้างใบเสร็จจากใบแจ้งหนี้',
            'custom_date_range': 'กำหนดช่วงวันที่เอง',
            'customer': 'ลูกค้า',
            'customer_detail': 'รายละเอียดลูกค้า',
            'date': 'วันที่',
            'date_filter_job_card': 'ตัวกรองวันที่ของ Job Card',
            'email': 'อีเมล',
            'enter_new_name': 'กรอกชื่อใหม่',
            'filter_tasks': 'กรองงาน',
            'hashtag_add_failed': 'เพิ่มแฮชแท็กไม่สำเร็จ',
            'hashtag_add_success': 'เพิ่มแฮชแท็กสำเร็จ',
            'hashtag_remove_failed': 'ลบแฮชแท็กไม่สำเร็จ',
            'hashtag_remove_success': 'ลบแฮชแท็กสำเร็จ',
            'last_month': 'เดือนที่แล้ว',
            'last_week': 'สัปดาห์ที่แล้ว',
            'name_cannot_be_empty': 'ชื่อห้ามว่าง',
            ...
            'no_permission_send_message': 'คุณไม่มีสิทธิ์ส่งข้อความ',
            ...
            'phone': 'โทรศัพท์',
            'pin': 'ปักหมุด',
            'pin_update_failed': 'อัปเดตสถานะปักหมุดไม่สำเร็จ',
            'purchase_count': 'จำนวนครั้งที่ซื้อ',
            ...
            'select_customers_multiple': 'เลือกลูกค้า (เลือกได้หลายคน)',
            'select_date_type': 'เลือกประเภทวันที่:',
            'select_end_date': 'เลือกวันที่สิ้นสุด',
            'select_hashtags_multiple': 'เลือกแฮชแท็ก (เลือกได้หลายรายการ)',
            'select_interests_multiple': 'เลือกความสนใจ (เลือกได้หลายรายการ)',
            'select_seller': 'เลือกผู้ขาย',
            'select_seller_hint': 'เลือกผู้ขายเพื่อกรอง',
            ...
            'show_unselected_dates': 'แสดงวันที่ที่ไม่ได้เลือก',

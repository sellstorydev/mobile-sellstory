...
class AppTranslations extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    'en_US': {
      ...
      'add': 'Add',
      // (Removed duplicate block of chat / job card / picker / card settings keys to resolve duplicate map entries)
      ...
      // Removed duplicate customer_detail_title (use consolidated key below)
          'edit_button': 'Edit',
          'customer_information': 'Customer Information',
      // Customer Detail Page (added 2025-09-24)
      // (Deprecated) customer_delete_* keys superseded by confirm_delete_customer + message
      'customer_permission_denied_detail':
          'You do not have permission to view this customer',
      'customer_permission_denied_jobcards':
          'You do not have permission to view Job Cards for this customer',
      'customer_permission_denied_todos':
          'You do not have permission to view To-Dos for this customer',
      'customer_no_jobcards': 'No Job Card for this customer yet',
      'customer_no_todos': 'No to-dos for this customer yet',
      'customer_section_history': 'History',
      'customer_section_document_library': 'Document Library',
      'customer_section_notes': 'Notes',
      'customer_section_sales_documents': 'Sales Documents',
      // Customer Detail additional sections & fields
      'customer_section_basic_info': 'Customer Information',
      'customer_section_contact_info': 'Contact Information',
      'customer_section_company_info': 'Company Information',
      'customer_section_address': 'Address',
      'customer_section_additional_info': 'Additional Information',
      'customer_section_system_info': 'System Information',
      'customer_field_customer_id': 'Customer ID',
      'customer_field_name': 'Name',
      'customer_field_gender': 'Gender',
      'customer_field_age': 'Age',
      'age_year_suffix': 'yrs',
      'customer_field_type': 'Type',
      'customer_field_national_id': 'National ID',
      'customer_field_source': 'Source',
      'customer_field_created_at': 'Created At',
      'customer_field_updated_at': 'Last Updated',
      'from_job_card': 'From Job Card:',
      // Customer detail tab labels with counts
      'customer_tab_jobcards': 'Job Cards ({count})',
      // Consolidated Customer Detail localized strings (en)
      'customer_detail_title': 'Customer Details',
      'confirm_delete_customer': 'Confirm Delete Customer',
      'confirm_delete_customer_message':
          'Are you sure you want to delete customer "{name}"?',
      'no_permission_view_jobcards_customer':
          'You do not have permission to view this customer\'s Job Cards',
      'no_jobcards_for_customer': 'No Job Cards for this customer yet',
      'todo_due_date_with_value': 'Due: {date}',
      'customer_tab_history_coming_soon': 'History\n(Coming Soon)',
      'customer_tab_document_library_coming_soon':
          'Document Library\n(Coming Soon)',
      'customer_tab_notes_coming_soon': 'Notes\n(Coming Soon)',
      'customer_tab_sales_documents_coming_soon':
          'Sales Documents\n(Coming Soon)',
      'customer_tab_todos': 'To-Dos ({count})',
      'customer_tab_history': 'History ({count})',
      'customer_tab_document_library': 'Document Library ({count})',
      'customer_tab_notes': 'Notes ({count})',
      'customer_tab_sales_documents': 'Sales Documents ({count})',
      'coming_soon_multiline': 'Coming Soon',
      'repeat_purchase_count': 'Repeat Purchase Count',
      'total_payment_amount': 'Total Payment Amount',
      'customer_code_with_value': 'Customer ID: {code}',
      'todo_completed': 'Completed',
      'todo_not_completed': 'Not completed',
      ...
      // Job Card picker (moved to consolidated block below)
      ...
      'iap_menu': 'Upgrade / Premium',
      'iap_title': 'Premium Upgrade',
      'iap_ios_only': 'Available only on iOS',
      'iap_not_available': 'Store not available',
      'iap_no_products': 'No products available',
      'iap_restore': 'Restore',
      'iap_buy': 'Buy',
      'iap_owned': 'Owned',
      'iap_purchase_failed': 'Purchase failed: {error}',
      'iap_purchase_stream_error': 'Purchase stream error: {error}',
      'iap_query_products_failed': 'Failed to load products: {error}',
      'iap_products_not_found': 'Products not found in store: {ids}',
            'iap_products_empty_hint': 'Products list returned empty. If App Store Connect setup is new, wait a few hours for propagation.',
            'iap_refresh': 'Refresh',
            'iap_force_mock': 'Force Mock Mode',
            'iap_force_mock_title': 'Force Mock Mode',
            'iap_force_mock_desc': 'Using a local simulated purchase environment. Disable to reconnect to the App Store.',
            'iap_force_mock_enabled': 'Force mock mode enabled',
            'iap_exit_force_mock': 'Exit Mock Mode',
            'iap_no_products_title': 'No Products Yet',
            'iap_no_products_desc': 'We could not load product details from the App Store. Follow the checklist below or retry later.',
            'iap_debug_title': 'Debug Info',
            'iap_debug_configured_ids': 'Configured IDs: {ids}',
            'iap_debug_not_found_ids': 'Not Found IDs: {ids}',
            'iap_debug_error': 'Error: {error}',
            'iap_guidance_title': 'Checklist to Show Products',
            'iap_guidance_step_1': 'In App Store Connect > In-App Purchases, ensure the product ID exists and is in Ready to Submit or Approved state.',
            'iap_guidance_step_2': 'Add localization (Display Name & Description) and a price for the product.',
            'iap_guidance_step_3': 'Create a Sandbox tester Apple ID and sign out of your real App Store account on the device. Sign in with the sandbox account only when prompted at purchase.',
            'iap_guidance_step_4': 'Install this build on a physical iOS device (not simulator) from Xcode or TestFlight.',
            'iap_guidance_step_5': 'Wait for App Store propagation (can take up to several hours after first creation). Then tap Refresh.',
    'iap_simulator_mode': 'Simulator Mode (Mock Purchases)',
    'iap_simulator_mock_product': 'Simulated Product: {id}',
    'iap_simulator_notice': 'Running on iOS Simulator. Real App Store product details are not returned here. Use this mock button to simulate an owned state. Test real purchases on a physical device with a Sandbox Apple ID.',
    ...
    'add_product_hint': 'Click "Add Product" to start adding products or services',
      ...
      // Orders Module
    // (Removed duplicate navigation/menu keys block)
      ...
      // (Removed duplicate chat status & pin block - canonical definitions earlier around line ~400)
      // Add filter chip labels
      // (Removed duplicate canned responses block - canonical earlier definitions retained)
      // (Removed duplicate chat & picker labels - canonical earlier definitions retained)
      // Hashtag modal
      // (Removed duplicate hashtag / unlink customer block - canonical earlier definitions retained)
      // (Removed duplicate job card / workspace / chat rename block - canonical earlier definitions retained)
      // (Removed duplicate chat more sheet / upload block - canonical earlier definitions retained)
    ...
    // Job Card actions (added 2025-09-24)
    'add_jobcard': 'เพิ่ม Job Card',
    'jobcard_linked_success': 'เชื่อม Job Card แล้ว',
    'jobcard_link_failed': 'เชื่อม Job Card ไม่สำเร็จ',
    'jobcard_not_found': 'ไม่พบ Job Card',
    'jobcard_open_failed': 'เปิด Job Card ไม่สำเร็จ',
    'jobcard_deleted': 'ลบ Job Card แล้ว',
    'jobcard_delete_failed': 'ลบ Job Card ไม่สำเร็จ',
      ...
      // Products Page (English) - added 2025-09-24
      // Ensure no duplication: these keys currently only exist in Thai section
      'products': 'Products',
      'add_product': 'Add Product',
      ...
      // Product Detail Page (English) additional keys (2025-09-24)
      'product_sku': 'SKU',
      'unit': 'Unit',
      'details': 'Details',
      'barcode': 'Barcode',
    ...
    'th': {
      ...
      'total': 'รวม',
      // In-App Purchases (iOS)
      'iap_menu': 'อัปเกรด / พรีเมียม',
      'iap_title': 'อัปเกรดพรีเมียม',
      'iap_ios_only': 'ใช้ได้เฉพาะบน iOS',
      'iap_not_available': 'ไม่สามารถเชื่อมต่อ Store ได้',
      'iap_no_products': 'ยังไม่มีสินค้าให้ซื้อ',
      'iap_restore': 'กู้คืน',
      'iap_buy': 'ซื้อ',
      'iap_owned': 'มีสิทธิ์แล้ว',
      'iap_purchase_failed': 'ซื้อไม่สำเร็จ: {error}',
      'iap_purchase_stream_error': 'สตรีมการซื้อผิดพลาด: {error}',
      'iap_query_products_failed': 'โหลดสินค้าไม่สำเร็จ: {error}',
      'iap_products_not_found': 'ไม่พบสินค้าใน Store: {ids}',
    'iap_simulator_mode': 'โหมดจำลอง (ทดสอบการซื้อ)',
    'iap_simulator_mock_product': 'สินค้าจำลอง: {id}',
    'iap_simulator_notice': 'กำลังรันบน iOS Simulator จะไม่ได้รับข้อมูลสินค้าจริงจาก App Store ใช้ปุ่มจำลองนี้เพื่อทดสอบสิทธิ์การใช้งาน ทดสอบการซื้อจริงบนอุปกรณ์จริงด้วย Sandbox Apple ID',
    ...
    'add_product_hint': 'คลิก "เพิ่มสินค้า" เพื่อเริ่มเพิ่มสินค้า หรือบริการ',
      ...
      'searching_customers': 'กำลังค้นหาลูกค้า...',
